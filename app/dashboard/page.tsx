      ...
      <div className="grid grid-cols-1 xl:grid-cols-3 gap-6">
        ...
        <div className="xl:col-span-2 bg-white rounded-lg shadow overflow-hidden">
          <div className="px-6 py-4 border-b border-gray-200 flex justify-between items-center">
            <h2 className="text-lg font-medium text-[rgb(24,62,105)]">Current Projects</h2>
            <button className="text-sm text-[rgb(236,107,44)] hover:text-[rgb(220,100,40)] font-medium">
              View All
            </button>
          </div>
          <div className="p-2">
        ...
        <div className="bg-white rounded-lg shadow overflow-hidden">
          <div className="px-6 py-4 border-b border-gray-200 flex justify-between items-center">
            <h2 className="text-lg font-medium text-[rgb(24,62,105)]">Upcoming Tasks</h2>
            <button className="text-sm text-[rgb(236,107,44)] hover:text-[rgb(220,100,40)] font-medium">
              View All
            </button>
          </div>
